...
A=permute(A,[1:(nA-1),(nA+1):ndA nA]); % moves dimension nA to be the last dimension of A
A=reshape(A,prod(dA([1:nA-1 nA+1:ndA])),dA(nA)); % converts A to be a 2-dim matrix
